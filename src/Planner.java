...
public class Planner {
    ...
    public void init() {
        ...
        // Adding an item to the month-calendar
        this.calendarController.addCalendarActivity(1, schedule.getLocation(1), schedule.getAttraction(1), ZonedDateTime.now(), ZonedDateTime.now().plusHours(3));
